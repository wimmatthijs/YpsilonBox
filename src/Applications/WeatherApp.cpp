...
WeatherApp::WeatherApp(Weather_APP_information* _settings,GxEPD2_BW<GxEPD2_154_D67, GxEPD2_154_D67::HEIGHT>* _displayPointer, String* _Time_str, String* _Date_str, bool _metric){
  settings = _settings;
