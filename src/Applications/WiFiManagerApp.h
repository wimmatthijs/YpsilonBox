...
class WiFiManagerApp{
        ...
        "<input placeholder='8' style='width: 2em; margin: 0 10px 10px 10px;' size='2' maxlength='2' type='number' id='goldAPI_hours' name='goldAPI_hours' min='0' max='23'>:";
        const char* goldAPI_minutes_str = 
        "<input placeholder='30' style='width: 2em; margin: 0 10px 10px 10px;' size='2' maxlength='2' type='number' id='goldAPI_minutes' name='goldAPI_minutes' min='0' max='59'><br>";
        /*const char* weatherAPI_hours_str = 
        "<input placeholder='12' style='width: 2em; margin: 0 10px 10px 10px;' size='2' maxlength='2' type='number' id='weatherAPI_hours' name='weatherAPI_hours' min='0' max='23'>:";
        const char* weatherAPI_minutes_str = 
        "<input placeholder='0' style='width: 2em; margin: 0 10px 10px 10px;' size='2' maxlength='2' type='number' id='weatherAPI_minutes' name='weatherAPI_minutes' min='0' max='59'><br>";
        */const char* logo_hours_str = 
        "<input placeholder='16' style='width: 2em; margin: 0 10px 10px 10px;' size='2' maxlength='2' type='number' id='logo_hours' name='logo_hours' min='0' max='23'>:";
        const char* logo_minutes_str = 
        "<input placeholder='30' style='width: 2em; margin: 0 10px 10px 10px;' size='2' maxlength='2' type='number' id='logo_minutes' name='logo_minutes' min='0' max='59'><br>";
